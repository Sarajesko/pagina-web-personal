...
**Paso actual:** **0.4** — SVG mapa Europa *(esperando tu validación del 0.2)*
...
| 0.4 | Recopilar / buscar **SVG mapa Europa** en relieve (licencia libre) | `assets/maps/` | `[ ]` |
...
| jun. 2026 | 0.2 | Git init + `.gitignore` — pendiente OK Pablo |
